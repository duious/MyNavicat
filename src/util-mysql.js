...
export const SQL_DEF = {
  ...
  'ALL_VIEWS': 'SELECT TABLE_NAME, CHECK_OPTION, IS_UPDATABLE, SECURITY_TYPE, DEFINER FROM INFORMATION_SCHEMA.VIEWS WHERE TABLE_SCHEMA = ? ORDER BY TABLE_NAME ASC;',
  'SHOW_PROCEDURE': 'SHOW PROCEDURE STATUS WHERE Db = ?;',
  'SHOW_FUNCTION': 'SHOW FUNCTION STATUS WHERE Db = ?;',
};
